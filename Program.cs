...
namespace day4
{
    internal class Program
    {
        ...
        {
            CarPicture carpicture = new CarPicture();   // 인스턴스 생성
            ...
            Console.WriteLine("파라미터를 갖는 생정자의 자동차의 높이 : " + carpicture2.Height);
            Console.WriteLine("파라미터를 갖는 생정자의 자동차의 이름 : " + carpicture2.car_name);
            Console.WriteLine("파라미터를 갖는 생정자의 자동차의 색깔 : " + carpicture2.color);
